...
import factory.edgeFactory.WordEdgeFactory;
        ...
        label1: while (true) {
            ...
            while (true) {
                ...
                case "15":
                    ...
                    System.out.println();
                    System.out.println(app.graph.vertices()+" vertexs:");
                    for (Vertex v1 : app.graph.vertices()) {
                ...
                case "21":
                    ...
                    if (temp[0].equals("WordNeighborhood")) {
                        ef = new WordEdgeFactory();
