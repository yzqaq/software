...
import factory.edgeFactory.CommentEdgeFactory;
import factory.edgeFactory.EdgeFactory;
import factory.edgeFactory.FordwardEdgeFactory;
import factory.edgeFactory.FriendEdgeFactory;
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (flag.equals("1")) {
                ...
                app = new SocialNetWorkApp(corpus);
        ...
        label1: while (true) {
            ...
            while (true) {
                ...
                case "14":
                    ...
                    for (Vertex v1 : app.graph.vertices()) {
                        if (v1.getLabel().equals(name)) {
                            ...
                            System.out.println(GraphMetrics.inDegreeCentrality(app.graph, v1));
                            System.out.println("outDegreeCentrality:");
                            System.out.println(GraphMetrics.outDegreeCentrality(app.graph, v1));
                            continue label1;
                        }
                    }
                    System.out.println("未找到该点");
                ...
                case "21":
                    ...
                    if (temp[0].equals("FriendTie")) {
                        ef = new FriendEdgeFactory();
                        ...
                        app.graph.addEdge(e);
                        continue label1;
                    } else if (temp[0].equals("CommentTie")) {
                        ef = new CommentEdgeFactory();
                        ...
                        app.graph.addEdge(e);
                        continue label1;
                    } else if (temp[0].equals("ForwardTie")) {
                        ef = new FordwardEdgeFactory();
