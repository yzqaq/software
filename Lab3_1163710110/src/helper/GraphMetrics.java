...
public class GraphMetrics {
     ...
     * @return
     */
   public  static <L, E> double degreeCentrality(final Graph<L, E> g, final L v) {
     ...
     * @return
     */
   public  static <L, E> double degreeCentrality(final Graph<L, E> g) {
  ...
  public   static <L, E> double closenessCentrality(final Graph<L, E> g, final L v) {
        int size = g.vertices().size();
        double temp = 0;
     ...
     * @return
     */
 public   static <L, E> double betweennessCentrality(final Graph<L, E> g, final L v) {
     ...
     * @return
     */
  public  static <L, E> double inDegreeCentrality(final Graph<L, E> g, final L v) {
        int num = g.vertices().size() - 1;
        int num0 = g.sources(v).size();
     ...
     * @return
     */
  public  static <L, E> double outDegreeCentrality(final Graph<L, E> g, final L v) {
        int num = g.vertices().size() - 1;
    ...
    public  double getDistance(final Vertex a, final Vertex b,final ConcreteGraph graph) {
        if (a.equals(b)) {
            return 0;
        } else {
            double d = 1;
