...
public class GraphMetrics {
     ...
     * @return
     */
    static <L, E> double degreeCentrality(final Graph<L, E> g, final L v) {
     ...
     * @return
     */
    static <L, E> double degreeCentrality(final Graph<L, E> g) {
    ...
    static <L, E> double closenessCentrality(final Graph<L, E> g, final L v) {
        int size = g.vertices().size();
        double temp = 0;
     ...
     * @return
     */
    static <L, E> double betweennessCentrality(final Graph<L, E> g, final L v) {
     ...
     * @return
     */
    static <L, E> double inDegreeCentrality(final Graph<L, E> g, final L v) {
        int num = g.vertices().size() - 1;
        int num0 = g.sources(v).size();
     ...
     * @return
     */
    static <L, E> double outDegreeCentrality(final Graph<L, E> g, final L v) {
        int num = g.vertices().size() - 1;
    ...
    private double getDistance(final Vertex a, final Vertex b,final ConcreteGraph graph) {
        if (a.equals(b)) {
            return 0;
        } else {
            double d = 1;
